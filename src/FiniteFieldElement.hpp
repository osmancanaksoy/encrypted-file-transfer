...
namespace Cryptography
{
    ...
    */
    ...
    public:
        ...
        FiniteFieldElement<P>& operator%=(const FiniteFieldElement<P>& rhs)
        {
            int result = i_ % rhs.i_;
            i_ = (result < 0) ? result + P : result;
            return *this;
        }

        // % with integer
        FiniteFieldElement<P>& operator%=(int rhs)
        {
            int result = i_ % rhs;
            i_ = (result < 0) ? result + P : result;
            return *this;
        ...
        {
            int result = lhs.i_ % rhs.i_;
            return FiniteFieldElement<P>((result < 0) ? result + rhs.i_ : result);
        ...
        friend FiniteFieldElement<P> operator/(int lhs, const FiniteFieldElement<P>& rhs)
        {
            return FiniteFieldElement<P>(lhs) / rhs;
        }
        // a / b
        friend FiniteFieldElement<P> operator/(const FiniteFieldElement<P>& lhs, const FiniteFieldElement<P>& rhs)
        {
